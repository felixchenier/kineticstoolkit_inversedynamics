...
#--------------------------------------------------------------------------------
name = "kineticstoolkit_inversedynamics"
description = "Provide functions to calculate inverse dynamics."
url = "https://github.com/GITHUBUSER/kineticstoolkit_inversedynamics"
